...
| #11 S33 block palette (SCRUM-108 S33-2: uGUI HUD) | **Done** | `Hullbreach.Builder.BlockPalette`, `Hullbreach.Game.BuilderHud` (a uGUI view over `Hullbreach.Hud.BuilderHudModel` now, not `OnGUI`; see `docs/design/ui-port.md`). Tests: `BlockPaletteTests.cs`. |
